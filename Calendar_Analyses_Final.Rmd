...
ggsave("plot.caldeicticEnglish.png", plot.deicticEnglish, dpi = 300, height = 3, width = 3)
...
ggsave("plot.CalremotenessEnglish.png", plot.remotenessEnglish, dpi = 300, height = 3, width = 3)
...
ggsave("plot.CalpreciseknowEnglish.png",plot.preciseknowEnglish, dpi = 300, height = 3, width = 3)
```
...
ggsave("plot.CalDSGerman.png", plot.DSGerman, dpi = 300, height = 3, width = 3)
...
ggsave("plot.CalremotenessGerman .png", plot.remotenessGerman , dpi = 300, height = 3, width = 3)
...
ggsave("plot.CalpreciseknowGerman.png",plot.preciseknowGerman, dpi = 300, height = 3, width = 3)
```
...
VerbalQuestions_Prop<- ggplot(data=verbal.sum1, aes(item, correct.m.v)) +
  geom_col() +
  facet_wrap(~agegroup) +
  coord_flip() +
  ylab('Proportion Correct (Verbal Questions)') +
  scale_y_continuous(breaks =  seq(0, 1, by  = .5)) +
  xlab('Item') +
  scale_x_discrete(labels = c("after-today", "tomorrow", "today","yesterday","before-today")) +
  ylim(0,1) +
  theme_minimal(base_size = 14) +
  theme(plot.title=element_text(family = "Times", color = "black", size = 14, hjust = 0.5), 
        axis.title.y = element_text(family = "Times", color = "black", size = 14),
