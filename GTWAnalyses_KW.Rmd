...
d.g <- mutate(d.g, response = ifelse(itemtype == 'deictic' & is.na(response2) == T, response1, 
                              ifelse(itemtype == 'verbal', response, response2)))
```
...
d.all <- d.all %>%
  ...
  mutate(cor.remote = case_when(task == "calendar" & itemtype == "deictic" & item == "yesterday" & resp.remoteness == '1' ~ '1',
                                task == "calendar" & itemtype == "deictic" & item == "beforeyesterday" & resp.remoteness == '2' ~ '1',
                                task == "calendar" & itemtype == "deictic" & item == "tomorrow" & resp.remoteness == '1' ~ '1',
                                task == "calendar" & itemtype == "deictic" & item == "aftertomorrow" & resp.remoteness == '2' ~ '1',
