...
```{r}
d.lm1 <- glmer(stat.correct.1 ~ language*prox*scale(ageyears) + (1|subjid), family = 'binomial', data=cal.d) #FTC
summary(d.lm1) 
...
d.lm3 <- glmer(stat.correct.1 ~ prox.ec*language.ec*scale(ageyears) + (0 + prox.ec|subjid), family = 'binomial', data=cal.d) #FTC
isSingular(d.lm3, tol = 1e-4)
...
```{r}
# remove interaction to interpret main effects
d.lm4 <- glmer(stat.correct.1 ~ prox.ec + language.ec + scale(ageyears) + (0 + prox.ec|subjid), family = 'binomial', data=cal.d) 
summary(d.lm4)
Anova(d.lm4, Type=3) #main effect of age


#d.lm5 <- glmer(stat.correct.1 ~ language + item + scale(ageyears) + (1|subjid), family = 'binomial', data=cal.d) 
#summary(d.lm5)
#Anova(d.lm5, Type=3) #main effect of age
```
...
```{r}
d.lm.7e <-  glmer(stat.correct.1 ~ prox.ec + scale(ageyears) + (0 + prox.ec|subjid), family='binomial', data=cal.e) 
summary(d.lm.7e)
Anova(d.lm.7e, Type=3) #main effect of age

d.lm.7g <-  glmer(stat.correct.1 ~ prox.ec + scale(ageyears) + (0 + prox.ec|subjid), family='binomial', data=cal.g) 
summary(d.lm.7g)
Anova(d.lm.7g, Type=3) #main effect of age
```
