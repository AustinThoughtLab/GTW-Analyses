...
#verbal_items <-  c("verbal") # pull out rows with verbal items
#deictic_items <- c("deictic") # pull out rows with verbal items
...
Calv.dgT$verbal_score_corfirst <- rowSums(Calv.dgT[,c("cor.first.beforetoday", "cor.first.yesterday")], na.rm = TRUE) #ignore missing data

Calv.deT <- reshape(Calv.de, idvar = c("subjid", "agegroup"), timevar = "item", direction = "wide")
#Calv.deT$verbal_score_corfirst <- rowSums(Calv.deT[,c("cor.first.beforetoday", "cor.first.yesterday")], na.rm = TRUE) #ignore missing data

# deictic_score = X

# combine scores into one data.fram
