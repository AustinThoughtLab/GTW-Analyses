...
#cal.allTrecoded %>%
  #mutate(BothCorrF = as.factor(BothCorr),
         #BothCorrF = recode_factor(BothCorrF, '1' = 'True',
                                   '0' = 'False'))

#as.factor(cal.allTrecoded$BothCorr)
#cal.allTrecoded %>%
  #mutate(BothCorr = recode_factor(BothCorr, '1' = "TRUE", 
                       '0' = "FALSE"))
...
#ggplot(cal.allTrecoded, aes(x=item, fill = BothCorr)) +
